...
Leave them blank — you'll write their contents together in Session 3.
...
- [ ] `models/treasureModel.ts`, `controllers/treasureController.ts`, and `routes/treasureRoutes.ts` exist (empty, ready to fill in)
